...
export default function Seo({ title, description, path, image, noindex = false }) {
  const fullTitle = title ? `${title} | ${SUFFIX}` : 'Shree Aadhitya Hospitals — Ayurvedic & Dental Care';
  ...
  return (
    <>
      ...
      <meta property="og:site_name" content="Shree Aadhitya Hospitals" />
