  ...
  return (
    <>
      <Seo
        ...
        description={content.ayurveda.hero.subtitle}
        path="/ayurveda"
        image="/og-ayurveda.png"
      />
      ...
      <TreatmentsSection
        practice="ayurveda"
        muted
        description="Traditional Ayurvedic consultations and therapies. Suitability is assessed by the physician."
      />
